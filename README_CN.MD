...
* 添加 [JoyCaption2Split](JoyCaption2Split), [LoadJoyCaption2Model](LoadJoyCaption2Model), [JoyCaption2ExtraOptions](JoyCaption2ExtraOptions) 节点，使用JoyCaption-Beta-One模型生成提示词。
